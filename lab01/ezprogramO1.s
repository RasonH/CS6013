...
# options passed:  -D_GNU_SOURCE ezprogram.cpp -mtune=generic -march=x86-64
# -auxbase-strip ezprogramO1.s -g -O2 -fverbose-asm
...
.LVL0:
.LFB12:
	.file 1 "ezprogram.cpp"
	.loc 1 3 22 view -0
	.cfi_startproc
	.loc 1 4 5 view .LVU1
# ezprogram.cpp:4:     return a + b;
	.loc 1 4 16 is_stmt 0 view .LVU2
...
.LVL1:
.LFB13:
	.loc 1 8 33 is_stmt 1 view -0
	.cfi_startproc
	.loc 1 9 5 view .LVU5
	.loc 1 4 5 view .LVU6
# ezprogram.cpp:8: int main(int argc, char *argv[]){
	.loc 1 8 33 is_stmt 0 view .LVU7
	subq	$8, %rsp	#,
	.cfi_def_cfa_offset 16
# ezprogram.cpp:9:     printf("%d\n", add(1,3));
	.loc 1 9 11 view .LVU8
	movl	$4, %esi	#,
.LVL2:
	.loc 1 9 11 view .LVU9
	movl	$.LC0, %edi	#,
.LVL3:
	.loc 1 9 11 view .LVU10
	xorl	%eax, %eax	#
	call	printf	#
.LVL4:
# ezprogram.cpp:10: }
	.loc 1 10 1 view .LVU11
	xorl	%eax, %eax	#
	addq	$8, %rsp	#,
...
.LASF92:
	.string	"/home/u1431422/Documents/CS6013/lab01"
.LASF31:
